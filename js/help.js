...
let help_data = {
	...
	civ: {
		id: "civ",
		title: "文明",
		text: "解锁文明以后，获取更多文明力量。你同时也需要获得更多 AI 节点，考虑按照这个顺序：AD -> BD & DB -> CD -> DD -> DA -> DC。对于人口来讲，先把它们分配给文明 5、4、3，然后再搞文明 1、2（不这么搞也没什么太大的影响）.然后拿更多的第七行资源，确保你的新第六行层（机器人 & 写法）已经完全自动化了。<br><br>获得所有你能获得的东西，之后应该就能通关了。",
